...
function App() {
  ...
  var [detailExam, setDetailExam] = useState(null);
  var [detailTab, setDetailTab] = useState("syllabus");
  var [cat, setCat] = useState("All");
  var [search, setSearch] = useState("");
  var [compare, setCompare] = useState([null, null]);
  var [plan, setPlan] = useState(loadData()?.plan || {selected:null,days:[]});
  var [saved, setSaved] = useState(loadData()?.saved || []);
  
  var T = getTheme(dark);
  
  useEffect(function() {
    saveData({plan:plan,saved:saved});
  }, [plan, saved]);
  ...
  function toggleSaved(exam) {
    setSaved(function(prev) {
      var idx = prev.findIndex(function(e) { return e.id === exam.id; });
      if (idx >= 0) return prev.filter(function(e) { return e.id !== exam.id; });
      return [exam].concat(prev);
    });
  }
  ...
  return (
    <>
      ...
      {showIntro && <IntroSequence onEnd={function() { setShowIntro(false); }} />}
        ...
        <>
          ...
          {!detailExam && (
            <div style={{
              ...
              <button
                onClick={function() { setNavTab("home"); }}
                style={{
                  flex: 1,
                  background: "none",
                  border: "none",
                  ...
                  fontSize: 10,
                  fontFamily: "inherit",
                  fontWeight: navTab === "home" ? 600 : 400,
                  color: navTab === "home" ? "#6366f1" : T.muted,
                  padding: "6px 0",
                  transition: "all 0.3s"
                }}
              >
              ...
              <button
                onClick={function() { setNavTab("compare"); }}
                style={{
                  flex: 1,
                  background: "none",
                  border: "none",
                  ...
                  fontSize: 10,
                  fontFamily: "inherit",
                  fontWeight: navTab === "compare" ? 600 : 400,
                  color: navTab === "compare" ? "#6366f1" : T.muted,
                  padding: "6px 0",
                  transition: "all 0.3s"
                }}
              >
              ...
              <button
                onClick={function() { setNavTab("chatbot"); }}
                style={{
                  flex: 1,
                  background: "none",
                  border: "none",
                  ...
                  fontSize: 10,
                  fontFamily: "inherit",
                  fontWeight: navTab === "chatbot" ? 600 : 400,
                  color: navTab === "chatbot" ? "#6366f1" : T.muted,
                  padding: "6px 0",
                  transition: "all 0.3s"
                }}
              >
              ...
              <button
                onClick={function() { setNavTab("planner"); }}
                style={{
                  flex: 1,
                  background: "none",
                  border: "none",
                  ...
                  fontSize: 10,
                  fontFamily: "inherit",
                  fontWeight: navTab === "planner" ? 600 : 400,
                  color: navTab === "planner" ? "#6366f1" : T.muted,
                  padding: "6px 0",
                  transition: "all 0.3s"
                }}
              >
